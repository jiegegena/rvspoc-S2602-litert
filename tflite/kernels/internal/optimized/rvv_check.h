...
// Detect RISC-V Vector extension (RVV 1.0) and define USE_RVV.
// The __riscv_vector macro is defined by the compiler when -march=rv64gcv
// is specified and the toolchain supports RVV intrinsics.
